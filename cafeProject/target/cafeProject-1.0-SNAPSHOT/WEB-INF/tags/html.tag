...
<%--    <c:url value="https://cdn.jsdelivr.net/npm/bootstrap@5.1.2/dist/css/bootstrap.min.css" var="cssUrl"/>--%>
<%--    <LINK rel="stylesheet" type="text/css" href="${cssUrl}">--%>
<%--    <c:url value="/js/main.js" var="javascriptUrl"/>--%>
<%--    <SCRIPT type="text/javascript" src="${javascriptUrl}/js/main.js"></SCRIPT>--%>
